...
const Started = () => {
    return (
        <div class="pb-16" style={{ backgroundColor: "#5A5B5C" }}>
            <div class="w-1/2 mx-auto text-justify">
                <h1 class="text-7xl text-center">HOW IT STARTED</h1>
                <div class="mt-16">
                    <p class="mb-5">IT WAS IN JUNE 2021 WHEN WE MET IN REAL LIFE FOR
                    ...
                    <p class="mb-5">WE BOTH HAD A STREETWEAR BRAND IN THE PAST. SOME
                        PEOPLE LOVED IT, SOME DIDN’T, BUT TO US IT WAS EVERYTHING
                        WE EVER WANTED IT TO BE – A REFLECTION OF OUR</p>
                    <div class="flex">
                        <div class="w-3/6">
                            <p class="mb-5">IN THAT MEETING, WE BOTH REALIZED THAT WE HAD
                            ...
                            <p class="mb-5">FAST FORWARD FOUR MONTHS LATER, AND WE WERE READY.
                            ...
                            <p class="mb-5">WITH OUR VISION AND OUR INVESTORS, IT WAS TIME TO
                        ...
                        <div class="w-5/6" style={{ backgroundImage: `url(${mannequin})`, backgroundSize: 'cover', backgroundSize: "100% 100%", backgroundPosition: "top center" }}>
                        </div>
                    </div>
                </div>
            </div>
            <p class="mt-64 text-center">© INTERNET MADE 2022 ALL RIGHTS RESERVED</p>
        </div>
    );
};
